...
if __name__ == "__main__":
    try:
        Component('Widget', 'metal', 5)  # Invalid component Widget should be uppercase
    except ValueError as e:
        print(e)

    try:
        Component('WIDGET', 'metle', 5)  # Invalid component metle is misspelled
    except ValueError as e:
        print(e)

    comp = Component('WIDGET', 'metal', 5)  # Valid component
    print(comp.name, comp.kind, comp.quantity)
